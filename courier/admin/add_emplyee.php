...
<div id="page-wrapper">
		...
		<div class="tab-content">
			<div class="tab-pane active" id="horizontal-form">
				<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">Emplyee ID :</label>
							<div class="col-sm-8">
								<input type="text" class="form-control1" name="ID" placeholder="Enter empID" required="" id="ID">
							</div>
						</div>
						...
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">Emplyee password :</label>
							<div class="col-sm-8">
								<input type="text" class="form-control1" name="pwd" placeholder="Enter password" required="" id="pwd">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select class="form-control" id="sel1" name="branch_location" onchange="show(this.value)">
								<option>select</option>
								<?php 
								$sql=mysqli_query($conn,"select * from branch");
									while($res=mysqli_fetch_array($sql))
	...
	if(isset($_REQUEST['Emplyee']))
	{
		...
		$sql="INSERT INTO `emplyee` (`id`, `name`, `role`, `branchid`, `branch_name`, `branch_location`, `dateofjoin`, `salary`,`Empid` , `pwd`) VALUES (NULL, '$name', '$role', '$branchid', '$branch_name', '$branch_location', '$dateofjoin', '$salary','$empid','$pwd')";
