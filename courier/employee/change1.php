		...
		<div class="tab-content">
			<div class="tab-pane active" id="horizontal-form">
				...
				<!--<div class="form-group">
						...
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">Enter New Weight :</label>
							<div class="col-sm-8">
								<input type="text" class="form-control1" name="state" placeholder="Enter New Weight" required="" id="dearname">
...
<?php 
  ...
  include('../connection.php');
	if(isset($_REQUEST['consignment']))
	{
			...
			$sql="UPDATE `consignment` SET `total_weight`='$state' WHERE `ccn`='$consignment'";
