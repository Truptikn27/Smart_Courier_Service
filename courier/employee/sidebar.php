...
<body class="sticky-header left-side-collapsed"  onload="initMap()">
  <section>
    ...
    <div class="left-side sticky-left-side">
      ...
      <div class="logo">
        <h1><a href="home.php"><span>Employee</span></a></h1>
      </div>
	 ...
	 <li class="menu-list">
         ...
         <li class="menu-list">
            <a href="#"><i class="lnr lnr-cog"></i>
              <span>Update</span></a>
            <ul class="sub-menu-list">       
            <li><a href="update_c.php">Update Weight</a> </li>
           <li><a href="change2.php">Update Status</a> </li>
             </ul>
          </li>
		    <li class="menu-list">
            <a href="#"><i class="lnr lnr-cog"></i>
              <span>Bill</span></a>
            <ul class="sub-menu-list">       
           <li><a href="generate.php">calculate Bill</a> </li>
            </ul>
          </li>
	...
	<li class="menu-list">
            <a href="#"><i class="lnr lnr-cog"></i>
              <span>Send Bill</span></a>
            <ul class="sub-menu-list">
	     <li><a href="sms.php">Send bill by SMS</a> </li>
		<li><a href="sendmail.php">Send bill by mail</a> </li>
            </ul>
          </li>
